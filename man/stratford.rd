...
\docType{data}
\alias{Stratford}            
\title{Daily maximum temperatures in Stratford}
\description{
The \code{Stratford} data frame has 73 rows and 2 columns of data containing daily maximum temperatures in Stratford every five days in 1990
}
\usage{
data(Stratford)
}     
...
\details{
Daily maximum temperatures from the station in Stratford, Texas, in the year 1990 were extracted. 
